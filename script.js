...
function handleYoutubeIconClick(event) {
  ...
  const embedCode = `<iframe class="embedBox" width="460" height="315" src="https://www.youtube.com/embed/${videoId}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`;
